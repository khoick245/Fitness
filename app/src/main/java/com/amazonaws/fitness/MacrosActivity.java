...
import static com.amazonaws.fitness.R.id.rdgSex;
...
public class MacrosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnMacrosCalculate = (Button) findViewById(R.id.btnMacrosCalculate);
        btnMacrosCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText edtHeigh = (EditText)findViewById(R.id.edtHeight);
                double height = Double.parseDouble(edtHeigh.getText().toString());
                EditText edtWeight = (EditText)findViewById(R.id.edtWeight);
                double weight = Double.parseDouble(edtWeight.getText().toString());
                double activityLevel = 0;
                RadioGroup rdgActivityLevel = (RadioGroup)findViewById(R.id.rdgActivityLevel);
                int activityLevelSelected = rdgActivityLevel.getCheckedRadioButtonId();
                RadioButton rdbActivitySelected = (RadioButton)findViewById(activityLevelSelected);
                if(rdbActivitySelected.getText().equals("I am sedentary"))
                    activityLevel = 1.2;
                else if(rdbActivitySelected.getText().equals("I am lightly active"))
                    activityLevel = 1.375;
                else if(rdbActivitySelected.getText().equals("I am moderately active"))
                    activityLevel = 1.55;
                else if(rdbActivitySelected.getText().equals("I am very active"))
                    activityLevel = 1.725;
                else if(rdbActivitySelected.getText().equals("I am super active"))
                    activityLevel = 1.9;


                RadioGroup rdgSex = (RadioGroup)findViewById(R.id.rdgSex);
                int sexSelected = rdgSex.getCheckedRadioButtonId();
                double MBR = 0;
                RadioButton rdbSex = (RadioButton)findViewById(sexSelected);
                if(rdbSex.getText().equals("Male"))    // male
                    MBR = (66 + (6.2 * weight) + (12.7 * height * 12) - (6.76 * age)) * activityLevel;
                else
                    MBR = (655.1 + (4.35 * weight) + (4.7 * height) - (4.7 * age)) * activityLevel;

                TextView edtMBR = (TextView)findViewById(R.id.txtBMR);
                edtMBR.setText("*YOUR BMR: " + MBR + " CALORIES/DAY");
            }
        });
    }
    ...
    private void showUserDetail(final String attributeType, final String attributeValue) {
        ...
        final EditText input = new EditText(MacrosActivity.this);
